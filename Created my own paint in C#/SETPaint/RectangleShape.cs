 ...
 * to the windows form ( solid rectangle and rubber band effect
 * rectangle) and it inherits from DrawObject all data members 
...
namespace SETPaint
{
    ...
    /// to the windows form ( solid Rectangle and rubber band heeffect
    /// rectangle) and it inherits from DrawObject all data members 
    /// and overwrites the  virtual functions in DrawObject.
    /// </summary>
    class RectangleShape : DrawObject
    {
       ...
       public RectangleShape(Color newLineColour, Color newFillColour, int newLineThickness)
       {
          startPoint = new Point(0, 0);
          endPoint = new Point(0, 0);
       ...
       /// Overwrites the parrent method and calls the function Draw() 
        ...
        /// </summary>
        /// <param name="g"></param>
        /// <param name="rectPen"></param>
        /// <param name="fillRect"></param>
        private void Draw(Graphics g, Pen rectPen, bool fillRect)
        {
           ...
           rectPen.Width = lineThickness;
           g.DrawRectangle(rectPen, rect);
           if (fillRect == true)
           {
              g.FillRectangle(new SolidBrush(fillColour), rect);
           }
        }
    }
}
